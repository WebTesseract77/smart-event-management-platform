...
export default function EventCardSkeleton() {
  return (
    <Card className="group h-full overflow-hidden rounded-[24px] border border-[#E8E1D5] bg-white shadow-sm animate-pulse">
      <div className="aspect-[16/10] bg-gradient-to-br from-[#F5F2EA] to-[#E8E1D5]" />
