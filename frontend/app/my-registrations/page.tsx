    ...
    >
      ...
      >
        <div className="flex min-w-0 items-center justify-between gap-3">
          ...
          <div className="shrink-0 rounded-full border border-[#E8E1D5] bg-[#FAF8F4] px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-[#0F4D3F] sm:text-[11px] sm:tracking-[0.24em]">
        ...
        <div className="mt-5 sm:mt-6 grid gap-2 sm:gap-2.5 text-xs sm:text-sm font-medium text-[#183028]">
          {bullets.map((bullet) => (
            <div key={bullet} className="flex items-center gap-2.5 sm:gap-3 rounded-xl sm:rounded-2xl border border-[#E8E1D5] bg-[#FAF8F4] px-3.5 py-2 sm:px-4 sm:py-2.5 shadow-sm">
              ...
              <span className="min-w-0 break-words text-xs font-medium text-[#183028] sm:text-sm">{bullet}</span>
            </div>
          ))}
        </div>

        <div className="mt-auto flex items-center gap-2 pt-6 text-xs font-semibold text-[#0F4D3F] sm:text-sm">
          <span>Explore</span>
